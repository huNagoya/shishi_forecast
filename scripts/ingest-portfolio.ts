...
const CHUNKS = [
  {
    chunk_id: 'intro',
    content: '高彦（Yan Gao），AI产品经理求职者。地球物理 × 神经网络背景，独立完成两款AI产品从0到上线全流程。联系方式：电话 18943734655，邮箱 yan.gao01@outlook.com。个人作品集：gaoyan.me',
  ...
  },
  {
    ...
    content: '如厕预测官（食事预报局功能模块二）：用户拍摄或描述所吃食物，结合进食时间与肠胃类型，AI预测消化通畅度（0-100分环形评分）、黄金如厕时间区间、便秘/腹泻双维度风险。支持上传食物图片或粘贴外卖订单，并提供针对性饮食搭配建议。',
    metadata: { section: 'project1', feature: '如厕预测官' },
  },
  {
  ...
  {
    chunk_id: 'philosophy',
    content: '高彦的产品理念与背景优势："懂技术的AI产品经理，不是会写代码，而是知道AI能做什么、不能做什么、以及如何用它解决真实问题。"地球物理数值模拟的科研背景带来将复杂问题转化为可计算模型的思维方式，独立完成两款AI产品全流程体现快速落地执行力，科研严谨性与产品直觉并重。',
